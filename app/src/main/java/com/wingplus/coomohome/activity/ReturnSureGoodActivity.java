 ...
 *         Create on 2017/11/1.
 */
public class ReturnSureGoodActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_return_sure_good);
    ...
    private void initView() {
        ...
        mRemark.setText("* 物流信息已提交，客服会在收到商品后处理退款");
        ...
        GlideUtil.GlideWithPlaceHolder(ReturnSureGoodActivity.this, aso.getGoodsPhoto())
                .apply(new RequestOptions().bitmapTransform(new RoundCornersTransformation(ReturnSureGoodActivity.this, UIUtils.dip2px(2), RoundCornersTransformation.CornerType.ALL)))
                .into(good_img);
        ...
        imgContent.setAdapter(new GridAdapter(aso.getImgUrl(), ReturnSureGoodActivity.this));
