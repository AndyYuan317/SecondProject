 ...
 */
public class ReturnCustomServiceActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_return_custom_service);
    ...
    private void initView() {
        ...
        EditText phone = findViewById(R.id.phone);
            ...
            mRemark.setText("* 申请已提交，等待客服受理，通常需要1-2个工作日");
        ...
        GlideUtil.GlideWithPlaceHolder(ReturnCustomServiceActivity.this, aso.getGoodsPhoto())
                .apply(new RequestOptions().bitmapTransform(new RoundCornersTransformation(ReturnCustomServiceActivity.this, UIUtils.dip2px(2), RoundCornersTransformation.CornerType.ALL)))
                .into(good_img);
        ...
        imgContent.setAdapter(new GridAdapter(aso.getImgUrl(), ReturnCustomServiceActivity.this));
