 ...
 *         Create on 2017/10/9.
 */
public class OrderWaitingCommitFragment extends OrderBaseFragment {
        ...
        rv.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (position == 0) {
                    ...
                    boolean onTop = dis >= paddingTop - 20;
                    LogUtil.e("onTop", dis + "--" + paddingTop + "--" + onTop);
                    tr.setEnableRefresh(onTop);
                } else {
                    tr.setEnableRefresh(false);
                }
    ...
    public LoadingPage.LoadResult load() {
        String rs = HttpUtil.GetDataFromNetByPost(APIConfig.getAPIUrl(APIConfig.API_ORDER_LIST)
                , new ParamsBuilder()
                        ...
                        .addParam("state", "" + Constant.OrderStatus.ORDER_STATUS_INT_WAITING_COMMIT)
                        .getParams());
